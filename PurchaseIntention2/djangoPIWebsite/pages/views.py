...
def result(request):
    from pages.StandardPreProcessing import output_to_results    
    if request.method == "GET":
        val = "ammar"
        return render(request, "result.html", {"out": val})
    elif request.method == "POST":   
        return render(request, "result.html", {"out1": output_to_results("pages/Annotated4.csv")})        
